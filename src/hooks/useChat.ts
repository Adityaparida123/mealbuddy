...
import type { ChatMessage, ChatContext, Role } from '../types/chat';
import { emptyContext } from '../types/chat';
...
export function useChat(menu: MenuItem[]) {
  ...
  // Persist whatever the conversation currently is. We never *append* here —
